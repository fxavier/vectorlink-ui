...
@Component({
  selector: 'app-add-spray-details',
  templateUrl: './add-spray-details.component.html',
  styleUrls: ['./add-spray-details.component.css']
})


export class AddSprayDetailsComponent implements OnInit {
  distritos = [
  ...
  situacao = [
    {label: 'Pulverizada', value: 1},
    {label: 'Não Pulverizada'}
  ];
